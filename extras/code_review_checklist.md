...
**Style Guide:** R code follows [Google's R Style Guide](https://google.github.io/styleguide/Rguide.xml). There is 
also a style guide from Hadley Wickham's 
[Advanced R book](http://adv-r.had.co.nz/Style.html) that is useful.
...
We expect that each person runs a linter (if you're not sure -- [ask](https://hicks-lab.slack.com/messages/codereview/)!) as part of their development environment.
...
We strongly recommend that repository maintainers select a 
maximum line length for code of 80 or 100 characters and 
that this be specified in a contributors document for the repository.
Plain text, markdown, and other text-based formats can alternatively
be broken at sentences. 
